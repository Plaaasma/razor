...
**HEAD = v0.12.1 (tag)** = v0.12.0 + **SMP helper diversity** (odd helpers reduce 1 less in LMR, +11 at 8T, row 68). v0.12.0 = v0.11.0 + **lazy SMP** (+95-117 at 8T). 1-thread bench 20008 (1T play identical throughout). Full line: v0.7.0 net + i32 + log-LMR + singular + IIR + conthist + SMP + SMP-diversity. **★ M1 milestone reached: ~10.6% vs SF18 at LTC (row 67); gap ~−370 (was ~−515 session start).** Clean, committed. Archives masters\razor-v0.8.0…v0.12.1.exe.
