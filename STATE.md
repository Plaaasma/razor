...
**★ DATAGEN (stronger-teacher) — THE mission eval lever, IN PROGRESS (2026-06-16 session 4):** net is teacher-limited at the public test80 label quality → relabel positions with SF18 (deeper than the public labels) for a stronger teacher. Tooling BUILT + validated:
