...
**★ HARD BLOCKER (2026-06-21): DISK. H: has only ~39 GB free (1.82 TB used).** The SF-scale campaign needs ~500 GB-1 TB (test80-2023 v6 = 6 months ~55 GB compressed/~110 GB decompressed; 10-20B positions = hundreds of GB). CANNOT download/stage that with 39 GB free. The campaign is blocked until the user frees ~1 TB on H:, adds storage, or designates a farm node with space (spark/dl380/mac/hetzner — check their free disk). test80-2023 v6 available at HF linrock/test80-2023 (jun-dec, 6 months). 2024 07-12 are .tar.zst (not v6-loadable). UNBLOCKED side-work available meanwhile: small search/SPEED items not yet tried (TT-aging, accumulator-inplace ~+3-5 each, SPRT-verifiable, no disk) — banked Elo but don't approach within-50.
